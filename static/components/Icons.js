...
const IconHistory = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v5h5"></path><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"></path></svg>;
...
window.IconAlertTriangle = IconAlertTriangle;
window.IconChevronRight = IconChevronRight;
window.IconLayoutDashboard = IconLayoutDashboard;
window.IconHistory = IconHistory;
window.IconCpu = IconCpu;
